...
# export USE_SNIPPET_SCORES="false"
...
SPM_OPTIONS=(
    ...
    # ../sentencepiece/output_models/enwiki16K
    ../wikiloader/spm/sl/raw_news_multiling_sl_sample1250.concat
...
do
    ...
    # echo "indexing: multiling_news_sl"
    # curl -# "localhost:9090/indexer/from_crawl?url=http://localhost:9090/static/testdocs/multiling-news-sl-sample1250/index.html&keyword=multiling-news-sl-sample1250" > /dev/null
    
    # echo "evaluating: multiling_news_sl"
    # python eval.py multiling_news_sl_sample1250 --pod multiling-news-sl-sample1250 --query_dir $PERSONAS_DIR/personas_queries/ --filter_frequent_2_and_3_token_queries
